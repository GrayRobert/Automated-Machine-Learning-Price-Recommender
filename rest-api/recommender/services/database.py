...
class DatabaseStorageController():
    ...
    def storeTrainedModel(self, independentVariables, dependentVariable, modelDescription, transformation, encodeCatList, encodeDateList, dropList, dummies, modelType, accuracyR2, accuracyRMSE, testJSON, scatterPlot):
        # do something
        model = ModelTraining(
