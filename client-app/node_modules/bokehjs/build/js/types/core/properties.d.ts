...
export declare const FontSize: typeof String;
...
export declare class AngleSpec extends AngleSpec_base {
    transform(values: Arrayable): Arrayable;
}
export declare class ColorSpec extends Color {
}
declare const DistanceSpec_base: {
    new (obj: HasProps, attr: string, default_value?: ((obj: HasProps) => {}) | undefined): {
        init(): void;
...
export declare class DistanceSpec extends DistanceSpec_base {
}
